        ...
        <div className="column-flex-container separated-columns">
          <div className="row-flex-container flex-row-centered">
            ...
            <div className="info-text">
              <p>I have recently graduated from the Software Engineering Immersive at General Assembly and continue to work there as a TA. Previously, I have built a career of 4 years in marketing, working in an international team.</p> 
              <br/>
